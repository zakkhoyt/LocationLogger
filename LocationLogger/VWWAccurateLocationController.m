//
//  VWWAccurateLocationController.m
//  LocationLogger
//
...
@interface VWWAccurateLocationController ()<CLLocationManagerDelegate>
@property (nonatomic, strong) CLLocationManager *locationManager;
@property (nonatomic) BOOL isRunning;
@property (nonatomic, copy) CLLocation *location;
@end

@implementation VWWAccurateLocationController


#pragma mark Public methods

+(VWWAccurateLocationController*)sharedInstance{
    static VWWAccurateLocationController *instance;
    if(instance == nil){
        instance = [[VWWAccurateLocationController alloc]init];
    }
    return instance;
}
...
//        if(self.location.horizontalAccuracy < 20){
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:VWWAccurateLocationControllerNewLocationKey object:nil];
            
            AppDelegate *appDelegate = [UIApplication sharedApplication].delegate;
            [appDelegate scheduleLocalNotificationWithMessage:[NSString stringWithFormat:@"App Currently Running. A. %@", self.location.description]];
